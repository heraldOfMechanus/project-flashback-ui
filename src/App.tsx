  ...
  <>
    <BrowserRouter>
      ...
      <Switch>
        ...
        <Route path="/trivia-question" render={() => <TriviaQuestionPage currentSet={currentSet} setCurrentSet={setCurrentSet} currentCard={currentCard} setCurrentCard={setCurrentCard} currentUser={authUser} setCurrentUser={setAuthUser} currentTopic={currentTopic} setCurrentTopic={setCurrentTopic}/>} />
